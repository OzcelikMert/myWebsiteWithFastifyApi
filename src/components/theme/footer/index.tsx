    ...
    Copyright = () => {
        return (
            <div className="text-center mt-3">
                <small>© {this.props.appData.settings.seoContents?.title} {(new Date()).getStringWithMask("yyyy")}. All rights reserved.</small>
            </div>
        );
    }
        ...
        return (
            <div className="row d-flex flex-wrap border-top pt-2 pt-md-5">
                <div className="col-12 col-lg-4 mt-3 mt-md-0">
                    <h1 className="fw-bold">{this.props.appData.settings.seoContents?.title}</h1>
                    ...
                    <ul>
                        <li>
                            <a href={this.getSocialMediaURL(SocialMediaKey.Twitter)}>
                                <span><i className="mdi mdi-twitter"></i> Twitter</span>
                            </a>
                        </li>
                        <li>
                            <a href={this.getSocialMediaURL(SocialMediaKey.Instagram)}>
                                <span><i className="mdi mdi-instagram"></i> Instagram</span>
                            </a>
                        </li>
                        <li>
                            <a href={this.getSocialMediaURL(SocialMediaKey.Facebook)}>
                                <span><i className="mdi mdi-facebook"></i> Facebook</span>
                            </a>
                        </li>
                        <li>
                            <a href={this.getSocialMediaURL(SocialMediaKey.Youtube)}>
                                <span><i className="mdi mdi-youtube"></i> Youtube</span>
                            </a>
                        </li>
                    </ul>
                </div>
...
ComponentToolFooter.initComponentServerSideProps = async (req, component) => {
    ...
    component.customData.hitBlogs = (await PostService.getMany({
        langId: req.appData.selectedLangId,
        statusId: StatusId.Active,
        typeId: [PostTypeId.Blog],
