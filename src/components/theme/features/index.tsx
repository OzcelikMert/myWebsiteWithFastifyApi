                    ...
                    <div className="row">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="card">
                                        ...
                                        <span>
                                          <i style={{color: "blue"}}
                                             className={`mdi mdi-${this.getComponentElementContents("feature1Icon")?.content}`}></i>
                                        </span>
                                            </div>
                                ...
                                <div className="col-md-6">
                                    <div className="card">
                                        ...
                                        <span>
                                          <i style={{color: "red"}}
                                             className={`mdi mdi-${this.getComponentElementContents("feature2Icon")?.content}`}></i>
                                        </span>
                                            </div>
                                    ...
                                    <div className="card">
                                        ...
                                        <span>
                                          <i style={{color: "orange"}}
                                             className={`mdi mdi-${this.getComponentElementContents("feature3Icon")?.content}`}></i>
                                        </span>
                                            </div>
                                ...
                                <div className="col-md-6">
                                    <div className="card">
                                        ...
                                        <span>
                                          <i style={{color: "green"}}
                                             className={`mdi mdi-${this.getComponentElementContents("feature4Icon")?.content}`}></i>
                                        </span>
                                            </div>
                        ...
                        <AnimationOnScroll animateIn="animate__fadeInRight" animateOnce={true} className="col-lg-5 content ps-lg-5 mt-3 mt-lg-0 d-flex flex-column text-center" animatePreScroll={false}>
                            ...
                            <div className="icons mt-auto pt-3">
                                ...
                                <a href={this.getSocialMediaURL(SocialMediaKey.Facebook)}><i
                                    className="mdi mdi-facebook p-2"></i></a>
                                <a href={this.getSocialMediaURL(SocialMediaKey.Twitter)}><i
                                    className="mdi mdi-twitter p-2"></i></a>
                                <a href={this.getSocialMediaURL(SocialMediaKey.Instagram)}><i
                                    className="mdi mdi-instagram p-2"></i></a>
                            </div>
                        </AnimationOnScroll>
                    </div>
                </div>
