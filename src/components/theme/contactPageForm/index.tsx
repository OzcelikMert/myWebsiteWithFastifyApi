...
class ComponentThemeContactPageForm extends ComponentHelperClass<IPageProps, IPageState> {
    ...
    async onSubmit(event: FormEvent) {
        ...
        this.setState({
            ...
            let serviceResult = await MailerService.send({
    ...
    ContactFormSuccessMessage = () => {
        return (
            <div>
                <h5 className="text-success animate__animated animate__fadeInUp">{this.getComponentElementContents("successMessage")?.content}</h5>
            </div>
        );
    }
            ...
            <div>
                <Form onSubmit={event => this.onSubmit(event)}>
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            type="text"
                            placeholder={this.getComponentElementContents("fullNameInput")?.content}
                            name="formData.name"
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            type="email"
                            placeholder={this.getComponentElementContents("emailInput")?.content}
                            name="formData.email"
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            type="text"
                            placeholder={this.getComponentElementContents("subjectInput")?.content}
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            as="textarea"
                            rows={5}
                            placeholder={this.getComponentElementContents("messageInput")?.content}
